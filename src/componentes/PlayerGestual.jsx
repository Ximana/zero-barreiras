...
export default function PlayerGestual({ sequencia, aoTerminar }) {
  ...
  const itemProximo =
    indice + 1 < sequencia.length ? sequencia[indice + 1] : null;
  ...
  const avancar = useCallback(() => {
    ...
    setOpacidades([slotActivo === 0 ? 0 : 1, slotActivo === 0 ? 1 : 0]);
    transRef.current = setTimeout(() => {
  ...
  const irPara = useCallback(
    (idx) => {
      ...
      if (sequencia[idx + 1])
        preCarregarProximo(bufferSlot, sequencia[idx + 1]);
    },
  ...
  const labelActual = itemActual
    ...
    : "";
  const subActual =
    itemActual?.tipo === "gesto"
      ? itemActual.descricao
      : "Vídeo de frase completa";
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        {terminado && (
          <div
            className="absolute inset-0 flex flex-col gap-3 justify-center items-center
            ...
            <div className="flex justify-between items-end gap-2">
              <div className="flex flex-col gap-1 min-w-0">
                <div className="flex items-center gap-2">
                  {itemActual.tipo === "frase" ? (
                    <span
                      className="flex-shrink-0 text-[10px] font-sans font-bold px-2 py-0.5
              ...
              <span
                className="flex-shrink-0 font-sans text-xs font-semibold text-white/70
          ...
          {sequencia.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="font-sans text-xs font-medium leading-tight text-center
                                 line-clamp-2 w-full"
                >
